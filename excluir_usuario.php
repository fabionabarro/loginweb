...
<head>
	...
	<body>
		<header>
			...
			<div class="body">
				 <div id="form">
					<form method="POST" action="executaexclusao_usuario.php">
		 	 		 ...
		 	 		 <br>
								   <input type="submit" value="Confirmar" name="enviar" class="balanco">
								   <input type="button" onclick="location.href='http://localhost/loginweb/usuario_view.php';" value="Consultar" class="balanco2" />
					</form>
				 </div>	
			</div>	 
	</body>
