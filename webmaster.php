...
include('verifica_webmaster.php');

$executa =" select * from consulta order by codigo";
	...
	<div class="body">
		...
		<?php
			while ($dados=mysqli_fetch_object($query)) {
				...
				echo "<td><a href='editar.php?codigo=$cod' >Editar</a></td>";
				echo "<td><a href='excluir.php?codigo=$cod' >	Excluir</a></td>";
